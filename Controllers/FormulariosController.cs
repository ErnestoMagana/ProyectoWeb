...
namespace ProyectoWeb.Controllers
{
    public class FormulariosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Email,Mensaje")] Formulario formulario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Email,Mensaje")] Formulario formulario)
        {
            if (id != formulario.Id)
            {
                return NotFound();
